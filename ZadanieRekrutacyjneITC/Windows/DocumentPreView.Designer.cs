namespace ZadanieRekrutacyjneITC.Windows
{
    partial class DocumentPreView
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.documentViewer1.Size = new System.Drawing.Size(760, 762);
            ...
            // ribbonControl1
            // 
            this.ribbonControl1.ApplicationButtonDropDownControl = this.documentViewer1;
            ...
            this.ribbonControl1.Size = new System.Drawing.Size(760, 150);
    ...
    "";
            ...
            toolTipTitleItem33.Text = "Page Setup";
            toolTipItem33.LeftIndent = 6;
            toolTipItem33.Text = "Show the Page Setup dialog.";
    ...
    "s to the document, click Custom Margins.";
            ...
            toolTipTitleItem34.Text = "E-Mail As PDF";
            toolTipItem34.LeftIndent = 6;
            toolTipItem34.Text = "Export the document to PDF and attach it to the e-mail.";
            ...
            toolTipTitleItem35.Text = "E-Mail As Text";
            toolTipItem35.LeftIndent = 6;
            toolTipItem35.Text = "Export the document to Text and attach it to the e-mail.";
            ...
            toolTipTitleItem36.Text = "E-Mail As CSV";
            toolTipItem36.LeftIndent = 6;
            toolTipItem36.Text = "Export the document to CSV and attach it to the e-mail.";
            ...
            toolTipTitleItem37.Text = "E-Mail As MHT";
            toolTipItem37.LeftIndent = 6;
            toolTipItem37.Text = "Export the document to MHT and attach it to the e-mail.";
            ...
            toolTipTitleItem38.Text = "E-Mail As XLS";
            toolTipItem38.LeftIndent = 6;
            toolTipItem38.Text = "Export the document to XLS and attach it to the e-mail.";
            ...
            toolTipTitleItem39.Text = "E-Mail As XLSX";
            toolTipItem39.LeftIndent = 6;
            toolTipItem39.Text = "Export the document to XLSX and attach it to the e-mail.";
            ...
            toolTipTitleItem40.Text = "E-Mail As RTF";
            toolTipItem40.LeftIndent = 6;
            toolTipItem40.Text = "Export the document to RTF and attach it to the e-mail.";
            ...
            toolTipTitleItem41.Text = "E-Mail As DOCX";
            toolTipItem41.LeftIndent = 6;
            toolTipItem41.Text = "Export the document to DOCX and attach it to the e-mail.";
            ...
            toolTipTitleItem42.Text = "E-Mail As Image";
            toolTipItem42.LeftIndent = 6;
            toolTipItem42.Text = "Export the document to Image and attach it to the e-mail.";
            ...
            toolTipTitleItem43.Text = "Export to PDF";
            toolTipItem43.LeftIndent = 6;
            toolTipItem43.Text = "Export the document to PDF and save it to the file on a disk.";
            ...
            toolTipTitleItem44.Text = "Export to HTML";
            toolTipItem44.LeftIndent = 6;
            toolTipItem44.Text = "Export the document to HTML and save it to the file on a disk.";
            ...
            toolTipTitleItem45.Text = "Export to Text";
            toolTipItem45.LeftIndent = 6;
            toolTipItem45.Text = "Export the document to Text and save it to the file on a disk.";
            ...
            toolTipTitleItem46.Text = "Export to CSV";
            toolTipItem46.LeftIndent = 6;
            toolTipItem46.Text = "Export the document to CSV and save it to the file on a disk.";
            ...
            toolTipTitleItem47.Text = "Export to MHT";
            toolTipItem47.LeftIndent = 6;
            toolTipItem47.Text = "Export the document to MHT and save it to the file on a disk.";
            ...
            toolTipTitleItem48.Text = "Export to XLS";
            toolTipItem48.LeftIndent = 6;
            toolTipItem48.Text = "Export the document to XLS and save it to the file on a disk.";
            ...
            toolTipTitleItem49.Text = "Export to XLSX";
            toolTipItem49.LeftIndent = 6;
            toolTipItem49.Text = "Export the document to XLSX and save it to the file on a disk.";
            ...
            toolTipTitleItem50.Text = "Export to RTF";
            toolTipItem50.LeftIndent = 6;
            toolTipItem50.Text = "Export the document to RTF and save it to the file on a disk.";
            ...
            toolTipTitleItem51.Text = "Export to DOCX";
            toolTipItem51.LeftIndent = 6;
            toolTipItem51.Text = "Export the document to DOCX and save it to the file on a disk.";
            ...
            toolTipTitleItem52.Text = "Export to Image";
            toolTipItem52.LeftIndent = 6;
            toolTipItem52.Text = "Export the document to Image and save it to the file on a disk.";
            ...
            toolTipTitleItem30.Text = "Open (Ctrl + O)";
            toolTipItem30.LeftIndent = 6;
            toolTipItem30.Text = "Open a document.";
            ...
            toolTipTitleItem31.Text = "Save (Ctrl + S)";
            toolTipItem31.LeftIndent = 6;
            toolTipItem31.Text = "Save the document.";
